...
class Post_state extends State<Post> with AutomaticKeepAliveClientMixin{
  ...
  init_likes() async {
    var email = Provider.of<Map>(context, listen: false)["email"];
  ...
  add_like() async{
    var email = Provider.of<Map>(context, listen: false)["email"];
    var image = Provider.of<Map>(context, listen: false)["image"];
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ClipOval(
                  child: Material(
                    ...
                    child: ava.isNotEmpty ?
                     Image.network(ava, width: 36, height: 36)
                    : Ink.image(
            ...
            GestureDetector(
              ...
              child: Row( children: [
                Image.network(widget.image, width: MediaQuery.of(context).size.width - 32, loadingBuilder:
                      ...
                      child: AnimatedContainer(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            widget.likes[0]['image'] != null ?
                            CircleAvatar(
                              backgroundImage: NetworkImage(widget.likes[0]['image']),
                            ) : const CircleAvatar(
                              backgroundImage: AssetImage("images/user.png"),
                            ),
                            widget.likes[1]['image'] != null ?
                            CircleAvatar(
                              backgroundImage: NetworkImage(widget.likes[1]['image']),
                            ) : const CircleAvatar(
                              backgroundImage: AssetImage("images/user.png"),
                            ),
                            widget.likes[2]['image'] != null ?
                            CircleAvatar(
                              backgroundImage: NetworkImage(widget.likes[1]['image']),
                            ) : const CircleAvatar(
                              backgroundImage: AssetImage("images/user.png"),
