      ...
      body: Consumer<ProfileProvider>(
        builder: (context, profile, child) => Stack(
          children: [
            ...
            profile.profile['posts'] != null ? Bottom_scroll(get_my_posts, profile.profile['posts'], "Мои записи", 135, 135, Icons.library_books_sharp, 0, widget.tab, on_tab) :
            Bottom_scroll_loading(135),
            profile.profile["liked"] != null ? Bottom_scroll(get_favorite, profile.profile["liked"], "Избранное", widget.tab != 0 ? 70 : 0, widget.tab != 0 ? 70 : 0,  Icons.favorite, 1,widget.tab, on_tab) :
